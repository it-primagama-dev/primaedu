                ...
                <tbody>
                    ...
                    {% if result is not empty %}
                        {% for list in result %}
                            ...
                            {% set subD2 = list.Nominal + list.Pembayaran %}
                            ...
                            {% if loop.last %}
								...
								<tr class="text-right" style="background: #f0f0f0; font-weight: bold">
                                    <td class="text-center" colspan="2" style="font-size: 35px;">Sisa Pembayaran</td>
                                    <td style="font-size: 35px;">{{ subD3|number_format(0,',','.') }}</td>
                                </tr>
