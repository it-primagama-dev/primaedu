...
<h1>
    ...
    TRACKING DETAIL <strong>{{ PR }}</strong>
</h1>
		...
		<tr>
			...
			{% if deposit is not empty %}
							{% for list in deposit %}
									...
									{%set DepositLain=list.DepositLain%}
			...
			{% if rest is not empty %}
					{% for list in rest %}
						{%if list.astatus=="Approved" or list.astatus=="OnHold" %}
							...
							<td  bgcolor="#FFEBCD">Yang di Bayarkan : <b>{%set NOMINAL=Deposit+DepositLain+list.NOMINAL%} Rp {{NOMINAL|number_format(0,',','.')}}</td>
		...
		<tr>
			...
			{% if weri is not empty %}
					{% for list in weri %}
						{%if list.ResiId!=""%}
							<td  bgcolor="#FFEBCD"><font Color="#000080"><b>OK</font></td>
							<td  bgcolor="#FFEBCD"><b>{{list.tgl}}</td>
							<td  bgcolor="#FFEBCD"><b>{{list.waktu}} WIB</td>	
						{% else %}
						<td>{{"NO"}}</td>
							<td>-</td>
				...
				{% else %}
					...
					{% if weri is not empty %}
							{% for list in weri %}
								{%set ke = ke + 1 %}
									<td ><B><font Color="#000000"><b>Koli {{ke}} : {{list.koli|number_format(0,',','.')}}</font></B></td>
									<td  ><B><font Color="#000000" colspan="2"><b> Resi Id {{ke}}: {{list.ResiId}}</font></B></td>
									<td ><B><font Color="#000000"><b>Expedisi : {{list.Expedisi}}</font> 
									<td ><B><font Color="#000000"><b>CP : {{list.CpExpedisi}}</font> 
...
{%if list.ResiId!="" %}	
			...
			{{ content() }}
				...
				<table class="table bordered hovered" id="header">
					<thead>
						<tr>
						<th bgcolor="#000080" rowspan="2"><font Color="#FFFFFF"><b> No.</font></th>
						<th bgcolor="#000080" rowspan="2"><font Color="#FFFFFF"><b> Nama Barang</font></th>
						 <th bgcolor="#000080" rowspan="2"><font Color="#FFFFFF"><b> Jumlah Barang yang di pesan</font></th>
						<th bgcolor="#000080" colspan="3"><font Color="#FFFFFF"><b> Jumlah Barang dikirim</font></th>
						<th bgcolor="#000080" colspan="3"><font Color="#FFFFFF"><b> Sisa Pesanan</font></th>
					   
						</tr>
						<tr>
						<th bgcolor="#000080"><font Color="#FFFFFF"><b> SB</font></th>
						<th bgcolor="#000080"><font Color="#FFFFFF"><b> SE1</font></th>
						<th bgcolor="#000080"><font Color="#FFFFFF"><b> SE2</font></th>
						<th bgcolor="#000080"><font Color="#FFFFFF"><b> SB</font></th>
						<th bgcolor="#000080"><font Color="#FFFFFF"><b> SE1</font></th>
						<th bgcolor="#000080"><font Color="#FFFFFF"><b> SE2</font></th>
						...
						{% if tampung is not empty %}
							{% for list in tampung %}
								...
								<tr>
									...
									{% if list.ItemId=='PB 12 SMK ' OR list.QtySE1 == '' Or list.TipeInvent == '6' Or list.TipeInvent == '5' Or list.TipeInvent == '7' Or list.TipeInvent == '8'%}
									<th>-</th>
									<th>-</th>
									{% elseif list.ItemId=='PB 7 SMP KURNAS' OR list.ItemId=='PB 8 SMP KURNAS' OR list.ItemId=='PB 9 SMP KURNAS' %}
									<th>{{list.QtySE1|number_format(0,',','.')}}</th>
									<th>-</th>
									{% else %}
									<th>{{list.QtySE1|number_format(0,',','.')}}</th>
									<th>{{list.QtySE2|number_format(0,',','.')}}</th>
									{% endif %}
									...
									<th>-</th>
									{% elseif list.ItemId=='PB 7 SMP KURNAS' OR list.ItemId=='PB 8 SMP KURNAS' OR list.ItemId=='PB 9 SMP KURNAS' %}
									{%set sisa1 = list.Qty - list.QtySE1 %}
									<th><font Color="#000080">{{ sisa1 }}</font></th>
									<th>-</th>
									{% else %}
									{%set sisa1 = list.Qty - list.QtySE1 %}
									<th><font Color="#000080">{{ sisa1 }}</font></th>
									{%set sisa2 = list.Qty - list.QtySE2 %}
									<th><font Color="#000080">{{ sisa2 }}</font></th>
									{% endif %}  
