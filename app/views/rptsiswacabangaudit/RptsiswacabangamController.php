...
class RptsiswacabangamController extends ControllerBase
{
 ...
 public function viewAction() {
        ...
        if (!$this->request->isPost()) {
            return $this->forward('Rptsiswacabangam/index');
        }
        ...
        $sql = "select VirtualAccount,MD,NamaJenjang,NamaSiswa,Cabang,sum(JumlahTotal)as JumlahTotal, 
...
+(select sum(jumlah) as uang from pembayarandetail join pembayaran on pembayaran.RecID=pembayarandetail.Pembayaran
                ...
                from
(select siswa.VirtualAccount,Siswa.RecId,Siswa.MD,areacabang.kodeareacabang, siswa.NamaSiswa,siswa.cabang, jenjang.NamaJenjang,
               ...
               and pembayarandetail.pembayaranuntuk='Pendaftaran'
                group by siswa.VirtualAccount,Siswa.MD,pembayaran.JumlahTotal, siswa.NamaSiswa, program.NamaProgram, siswa.cabang, siswa.RecID,Jenjang.NamaJenjang,
                tahunajaran.Description,pembayarandetail.Jumlah,areacabang.kodeareacabang) as cte
                group by VirtualAccount,MD,NamaSiswa,Cabang,RecID,kodeareacabang,NamaJenjang";
