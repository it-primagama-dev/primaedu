...
<h1>
    ...
    Cabang
    {% if admin %}
    <small class="place-right">{{ link_to("cabang/new", 'Tambah Baru<i class="icon-plus on-right smaller"></i>') }}</small>
    {% endif %}
</h1>
...
<table class="table bordered striped hovered">
    ...
    {% for areacabang in page.items %}
        <tr>
            ...
            <td width="7%">{{ link_to("cabang/edit/"~areacabang.RecID, "Edit") }}</td>
        </tr>
    {% endfor %}
    {% endif %}
    </tbody>
