...
<h1>
    ...
    Cabang
    <small class="on-right">Edit Data</small>
</h1>

{{ content() }}

{{ form("cabang/saveeditff", "onSubmit": "return validasi();", "method":"post", "enctype":"multipart/form-data","id":"AddForm") }}
...
<div class="grid fluid">
    ...
    <div class="row no-margin">
        <div class="span3">
            ...
            <div class="input-control text" data-role="input-control">
                <input type="hidden" name="KodeCabang2" value="{{ branchcode }}">
    ...
    <div class="row">
        ...
        <div class="span6">
            ...
            <div class="input-control textarea" data-role="input-control">
                {{ text_area("AlamatFranchisee", "maxlength" : 255) }}
    ...
    <div class="row no-margin">
        ...
        <div class="span3">
                ...
                {% if KTP != '' %}
                <a target="_blank" href="{{ url("public/uploads/"~KTP) }}">
                <img src="{{ url("public/uploads/"~KTP) }}" alt="Forest" style="width:100px" id="ktp2">
                </a>
                {% else %}
                <img src="{{ url("public/uploads/no-image.png") }}" alt="Forest" style="width:100px" id="ktp2">
                {% endif %}
        </div>
    </div>
    <div class="row no-margin">
        ...
        <div class="span3">
                ...
                {% if NPWP != '' %}
                <a target="_blank" href="{{ url("public/uploads/"~NPWP) }}">
                <img src="{{ url("public/uploads/"~NPWP) }}" alt="Forest" style="width:100px" id="npwp2" class="imgstl">
                </a>
                {% else %}
                <img src="{{ url("public/uploads/no-image.png") }}" alt="Forest" style="width:100px" id="npwp2" class="imgstl">
                {% endif %}
        </div>
    </div>
    <div class="row no-margin">
        <div class="span6">
            ...
            <div class="input-control select" data-role="input-control">
                {{ select_static("Statuskepemilikan",["":"---","Perorangan":"Perorangan","CV":"CV","PT":"PT","4":"Yanglain"]) }}
            </div>
        </div>
        <div class="span6">
            <label for="Yanglain">Yang lain....</label>
            <div class="input-control text" data-role="input-control">
                {{ text_field("YStatuskepemilikan","id":"YStatuskepemilikan", "maxlength" : 100, "disabled" :"true") }}
            </div>
        </div>
    </div>
    <div class="row no-margin">
    ...
    <div class="row no-margin">
        <div class="span6">
            <label for="Statuskepemilikan">Bentuk Bangunan</label>
            <div class="input-control select" data-role="input-control">
    ...
    <div class="row no-margin">
        <div class="span6">
            <label for="Statuskepemilikan">Status Bangunan</label>
            <div class="input-control select" data-role="input-control">
    ...
    <div class="grid fluid">
            ...
            {% if result is not empty %}
                    {% for list in result %}
<div class="row">
<input type="hidden" name="RecIDff" id="RecIDff" value="{{ list.RecID }}">
<label for="TanggalBerlaku">Tanggal Berlaku</label>
    <div class="span1">
       <div class="input-control text" data-role="input-control">
    ...
    <div class="span1">
        <div class="input-control text" data-role="input-control">
            <input type="number" maxlength="4" id="tahunBerlaku" name="tahunBerlaku" value="{{ list.TahunMulai }}" placeholder="Tahun" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
        </div>
    </div>
</div>
<div class="grid fluid">
...
<label for="TanggalBerakhir">Tanggal Berakhir</label>
    <div class="span1">
        <div class="input-control text">
             <input type="number" placeholder="Tanggal" maxlength="2" id="hariBerakhir" name="hariBerakhir" value="{{ list.hariBerakhir }}" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
        </div>
    </div>
    <div class="span1">
        <div class="input-control text">
            <input type="number" placeholder="Bulan" maxlength="2" id="bulanBerakhir" name="bulanBerakhir" value="{{ list.bulanBerakhir }}" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
        </div>
    </div>
    <div class="span1">
        <div class="input-control text">
            <input type="number" maxlength="4" id="tahunBerakhir" name="tahunBerakhir" value="{{ list.TahunAkhir }}" placeholder="Tahun" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
        </div>
    </div>
    </div>
</div>
...
<div class="row no-margin">
    <div class="span4">
        ...
        <div class="input-control text" data-role="input-control">
            <input type="text" id="NilaiFranchisee" name="NilaiFranchisee" class="Idr form-control"  onkeyup="calculate()" value="{{ list.NilaiFranchisee }}"/>
        </div>
    </div>
    <div class="span4">
        <label for="Diskon">Diskon</label>
        <div class="input-control text" data-role="input-control">
            <input type="text" id="Diskon" name="Diskon" class="Idr form-control" onkeyup="calculate()" value="{{ list.Diskon }}"/>
        </div>
    </div>
    <div class="span4">
...
<div class="row no-margin">
    <div class="span4">
        ...
        <div class="input-control text">
            <input type="text" name="NoMOU" id="NoMOU" value="{{ list.NoMOU }}"/>
        </div>
    </div>
    <div class="span4">
        <label for="total">Tanggal MOU</label>
            ...
            {% set TglMou_ = "" %}
            {% else %}
            {% set TglMou_ = list.TglMou %}
            {% endif %}
            <input type="text" name="TglMou" id="TglMou" value="{{ TglMou_ }}"/>
            </div>
    </div>
</div>
<div class="row no-margin">
    <div class="span6 ">
        ...
        <div class="input-control textarea" data-role="input-control">
            <textarea id="Keterangan" name="Keterangan" value="{{ list.Keterangan }}">{{ list.Keterangan }}</textarea>
        </div>
    </div>
            {% endfor %}
        {% endif %}
...
$('#Statuskepemilikan').change(function() {
  if ($(this).val() == 'Perorangan') {
    $('#YStatuskepemilikan').prop('disabled', true);
  ...
  {
   $('#YStatuskepemilikan').prop('disabled', false);
    $('#Direktur').prop('disabled', true);
    $('#SIUP').prop('disabled', true);
   $('#TDP').prop('disabled', true);
  }
...
$("document").ready(function() {
    ...
    $("#pic").change(function(t) {
        ...
        $("#ktp2").css("display", "none");
        } 
    });    
    $("#pic2").change(function(t) {
        if(t){
        $("#npwp1").css("display", "block");
        $("#npwp2").css("display", "none");
        } 
    });
});

function validasi() {
    if($('[name="pic"]').val() != "" && $('[name="pic2"]').val() == "") {
        alert("Harus diubah keduanya...");
        $('[name="pic2"]').focus();
        $(".loader").hide();
        return false; 
    } if($('[name="pic2"]').val() != "" && $('[name="pic"]').val() == "") {
        alert("Harus diubah keduanya...");
        $('[name="pic"]').focus();
        $(".loader").hide();
        return false;
