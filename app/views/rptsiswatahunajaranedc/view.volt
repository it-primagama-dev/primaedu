...
<table class="tablePrint" style="width:1000px">
    <tr>
        <td colspan="7">
            <table style="width:100%;">
                <tr>
                    ...
                    <td align="center" width="60%">
                        <h2><u> Laporan Transaksi Bank EDC</u></h2>
                    </td>
        ...
        <td colspan=15">
            <table class="table bordered hovered table2excel" style="width: 100%; border-collapse: collapse">
                <thead>
                    <tr>
                        <th width="5%">#</th>
                        <th width="10%">No. VA</th>
                        <th width="20%">Nama Siswa</th>
                        <th width="7%">Bank</th>
                        <th width="11%">Tanggal Transaksi</th>
                        <th width="11%">Tanggal Import</th>
                        <th width="12%">Nominal NET</th>
			<th width="8%">MDR</th>
			<th width="8%">Nominal Gross</th>
				...
				<td class="text-center">Rp {{ list.gros_amt|number_format(0,',','.') }}</td>
            ...
            {% endif %}
                    ...
                    <tr>
                        <th colspan='6' align='center'>TOTAL NET</th>

						<th  align='center' center colspan='3'>Rp {{total |number_format(0,',','.')}} </th>
