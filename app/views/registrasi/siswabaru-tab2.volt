<div class="grid fluid">    
    ...
    <div class="row">
        <div class="span3">
            ...
            <div class="input-control text" data-role="input-control">
                {{ text_field("BiayaPendaftaran", "class": "idrCurrency") }}
            </div>
        </div>
                <div><input type="hidden" id="BiayaPendaftaran2" class="idrCurrency"></input></div>
        <div class="span3">
    ...
    <div class="row">
        ...
        <div class="span3">
            <label for="TanggalJatuhTempo">Waktu Jatuh Tempo</label>
