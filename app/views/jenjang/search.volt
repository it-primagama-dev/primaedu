...
<div class="place-right">
    {{ link_to("jenjang/search", "First", 'class':'button') }}
    {{ link_to("jenjang/search?page="~page.before, "Previous", 'class':'button') }}
    {{ link_to("jenjang/search?page="~page.next, "Next", 'class':'button') }}
    {{ link_to("jenjang/search?page="~page.last, "Last", 'class':'button') }}
</div>