        ...
        <td colspan="7">
                    ...
                    {% if result is not empty %}
                        {% for list in result %}
                            ...
                            <tr class="text-center">
                                ...
                                <td class="text-center">Rp {{ (list.Uang_masuk-list.koreksi)|number_format(0,',','.') }}</td> <!--nominalku-->
                                <td class="text-center">Rp {{ list.uang|number_format(0,',','.') }}</td>
                                <td class="text-center">Rp {{ list.koreksi|number_format(0,',','.') }}</td>
                                {% set sisa= list.JumlahTotal-(list.Uang_masuk-list.koreksi)-list.uang %}
                                ...
                                <td class="text-center" bgcolor='red'>Rp {{ (list.Uang_masuk-list.koreksi)|number_format(0,',','.') }}</td> <!--Uang_masuk-->
                                ...
                                {% set sisa= list.JumlahTotal-(list.Uang_masuk-list.uang-list.koreksi-list.uang) %}
            ...
            {% endif %}         
                    ...
                    <tr>
                        ...
                        {% set grandtot = (biaya*11/100)-TOTTAL-sebelasdiscount%}
                        ...
                        <td  align='center'>Rp {{sebelasdiscount |number_format(0,',','.')}}</td>
                        <td  align='center'>&nbsp;</td>
                    ...
                    <tr>
                    <tr>
                        <th colspan='3' align='center'>GRAND TOTAL HUTANG (sudah dikurangi 11% MD)</th>                          
