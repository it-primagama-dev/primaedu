            ...
            <table class="table bordered hovered table2excel" style="width: 100%; border-collapse: collapse">
                <thead>
                    <tr>
                        ...
                        <th width="12%">Total Pembayaran dari Virtual Account</th>
                    </tr>
                </thead>
                <tbody>
                    {% if result is not empty %}
                        {% for list in result %}
                            ...
                            <tr class="text-center">
                                ...
                                <td class="text-right">{{ list.TotalPiutang|number_format(0,',','.') }}</td>
                                <td class="text-right">{{ list.TotalPembayaranVA|number_format(0,',','.') }}</td>
                            </tr>
                            {% if loop.last %}
                                <tr class="text-right" style="background: #f0f0f0; font-weight: bold">
                                    <td class="text-center" colspan="4">Sub Total</td>
