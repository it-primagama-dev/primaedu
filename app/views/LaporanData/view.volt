	...
	<tr><td width="500px">
					...
					<table border="1px" align='center'>
						...
						<tr>
							...
							<td  bgcolor="#191970" align="center"><font Color="#FFFFFF">QTY<font></td>    			
						</tr>
						{% set nilai = 0 %}
		...
		<td width="500px" >
			<table  border="1px" align='center'>
					...
					<tr>
						 <td align="center" height="25px" colspan="2"><font size="2px"><b>Total</b></font></td>
						<td  align="right" height="25px"><font size="2px"><b> {{ sum2013|number_format(0,',','.') }}</b></font></td>  
					</tr>
			</table>
		...
		<td width="500px" >
			<table  border="1px" align='center'>
					<tr>
						<td align="center" bgcolor="#191970" colspan="3" width="400px"><font Color="#FFFFFF" >PROGRAM KHUSUS<font></td>  
					</tr>
					<tr>
							<td   bgcolor="#191970" align="center" ><font Color="#FFFFFF">NO<font></td>
							<td  bgcolor="#191970" align="center"><font Color="#FFFFFF">DESCRIPTION<font></td> 
