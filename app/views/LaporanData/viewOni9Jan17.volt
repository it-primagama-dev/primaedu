    ...
    <tr>
        <td colspan="7">
            <table style="width:90%;">
				...
				<tr>
                    <td colspan="2" border='1px'>
                        <h3 style="margin: 2px 0"> No Hp : {{ rpt_hp }}</h3>
                    </td>
...
<table  style="width:100%;" border="1px" align='center'>
	<tr><td width="500px">
					...
					<table border="1px" align='center'>
						...
						{% set nilai = 0 %}
							 {% if result is not empty %}
								...
								<tr>
									{% set nilai = nilai+1 %}
									<td align="center"> <font size="2px"><b>{{ nilai }}</b></font></td>
		...
		<td width="500px" >
			<table  border="1px" align='center'>
					<tr>
						<td align="center" bgcolor="#4B0082" colspan="3" width="400px"><font Color="#FFFFFF" >PIKSE 2015/2016<font></td>  
					</tr>
					<tr>
							<td   bgcolor="#191970" align="center" ><font Color="#FFFFFF">NO<font></td>
							<td  bgcolor="#191970" align="center"><font Color="#FFFFFF">DESCRIPTION<font></td> 
		...
		<td width="500px" >
			<table  border="1px" align='center'>
					<tr>
						<td align="center" bgcolor="#FF4500" colspan="3" width="400px"><font Color="#FFFFFF" >PIKSUN<font></td>  
					</tr>
					<tr>
							<td   bgcolor="#191970" align="center" ><font Color="#FFFFFF">NO<font></td>
							<td  bgcolor="#191970" align="center"><font Color="#FFFFFF">DESCRIPTION<font></td> 
