...
<html>
    <head>
        ...
        {{ assets.outputJs('jsHeader') }}
            ...
            <div class="grid fluid"><br>
                        <font size="6">
            {{ link_to("barcode/index", '<i class="icon-arrow-left-3 fg-darker smaller"></i>') }} Input Barcode</font> <font size="4">- Area : {{ rpt_namaarea }}, Cabang : {{ rpt_namacabang }}</font>
                <div class="row">
                    <div class="span4">
    ...
    {% endif %}
                ...
                {{ link_to('barcode/all?cabang='~list.Cabang, "<u><i>Lihat Semua Barcode-->></i></u>") }}
                </div><br></br>
