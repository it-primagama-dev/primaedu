...
<table  style="width:100%;" border="1px" align='center'>
	<tr><td width="500px">
					...
					<table border="1px" align='center'>
						...
						<tr>
							 <td  align="center" height="25px" colspan="2"><font size="2px"><b>Total</b></font></td>
							<td align="right" height="25px"><font size="2px"><b>{{ sum1|number_format(0,',','.') }}</b></font></td>  
						<td  align="right" height="25px"> <font size="2px"><b>{{ sumSE15|number_format(0,',','.') }}</b></font></td>  
						<td  align="right" height="25px"> <font size="2px"><b>{{ sumSE25|number_format(0,',','.') }}</b></font></td>  
						</tr>
		...
		<td width="500px" >
			<table  border="1px" align='center'>
					...
					<tr>
						 <td align="center" height="25px" colspan="2"><font size="2px"><b>Total</b></font></td>
						<td  align="right" height="25px"><font size="2px"><b> {{ sum3|number_format(0,',','.') }}</b></font></td>   
						<td  align="right" height="25px"><font size="2px"><b> {{ sumSE14|number_format(0,',','.') }}</b></font></td>   
						<td  align="right" height="25px"><font size="2px"><b> {{ sumSE24|number_format(0,',','.') }}</b></font></td>   
					</tr>
			</table>
		...
		<td width="500px" >
			<table  border="1px" align='center'>
					...
					<tr>
						 <td align="center" height="25px" colspan="2"><font size="2px"><b>Total</b></font></td>
						<td  align="right" height="25px"><font size="2px"><b> {{ sum3nas|number_format(0,',','.') }}</b></font></td>  
						<td  align="right" height="25px"> <font size="2px"><b>{{ sumSE1|number_format(0,',','.') }}</b></font></td>  
						<td  align="right" height="25px"> <font size="2px"><b>{{ sumSE2|number_format(0,',','.') }}</b></font></td>  
					</tr>
			</table>
		...
		<td width="500px" >
			<table  border="1px" align='center'>
					<tr>
						<td align="center" bgcolor="#FFCC00" colspan="5" width="400px"><font Color="#000000" >PROGRAM KHUSUS<font></td>  
					</tr>
					<tr>
							<td bgcolor="#FFCC00" align="center"><font Color="#000000">NO<font></td> 
							<td bgcolor="#FFCC00" align="center"><font Color="#000000">DESCRIPTION<font></td> 
							...
							{% if result is not empty %}
							{% for list in result %}
							 {% if list.tahun=="2 SMK" OR list.tahun=="A IPA" or list.tahun=="A IPS" or list.tahun=="N SMP" or list.tahun=="UN SD" or list.tahun=="E IPA" or list.tahun=="E IPC" or list.tahun=="E IPS" or list.tahun=="KSTAN"%}
							{% set sum7 += list.Qty %}
					...
					<tr>
						 <td align="center" height="25px" colspan="2"><font size="2px"><b>Total</b></font></td>
						<td  align="right" height="25px"> <font size="2px"><b>{{ sum7|number_format(0,',','.') }}</b></font></td>  
					</tr>
			</table>
			<!--
			<br>
