...
<div align="center">
        <div class="span5">
            <label for="VaLama"><font color="blue" size="4px"> <b>Pernah Jadi Siswa Primagama...?</b></font></label>
            <div class="input-control text" data-role="input-control">
            <input type="text" id="VaLama" name="VaLama" Placeholder="Masukkan NoVA Lama Disini Untuk Melengkapi Data..." maxlength="11" value=""></input> 
        ...
        <div class="span2">
            <div class="input-control text" data-role="input-control">
            <button onclick="myFunction()">Sinkronkan</button>
            </div>
        </div>
</div>
        </form>
                ...
                $("#Kota").html(htmlcontent);
                    ...
                    $(document).ready(function(){
                        $('#userForm').submit(function(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'registersiswalama',
                                data: $(this).serialize()
                            })

                            .done(function(data){

                            $('#response').html(data);$(".loader").hide();
                            return;
                            })
