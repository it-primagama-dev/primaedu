...
class Rptsiswacabang1Controller extends ControllerBase
{
 ...
 public function viewAction() {
        ...
        $sql = "select VirtualAccount,MD, NamaSiswa, NamaJenjang,Cabang,sum(JumlahTotal)as JumlahTotal, 
(select sum(transaksibank.Nominal) as Uang_masuk from transaksibank where SUBSTRING(transaksibank.NoVA,5,7) = cte.VirtualAccount and SUBSTRING(transaksibank.NoVA,0,5)=cte.KodeAreaCabang and tahunajaran=$tahun)as Uang_masuk,
+(select sum(jumlah) as uang from pembayarandetail join pembayaran on pembayaran.RecID=pembayarandetail.Pembayaran
                ...
                from
(select siswa.VirtualAccount,Siswa.RecId,Siswa.MD,jenjang.NamaJenjang,areacabang.kodeareacabang, siswa.NamaSiswa,siswa.cabang, 
               ...
               and pembayarandetail.pembayaranuntuk='Pendaftaran'
                ...
                group by VirtualAccount,MD,NamaSiswa,Cabang,RecID,NamaJenjang,kodeareacabang";
