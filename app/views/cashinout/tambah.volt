...
{{ flash.output() }}
{{ form("cashinout/save", 'autocomplete': 'off','name': 'form', 'onSubmit': 'return validasi();','method': 'post') }}
    ...
    <div id="stepsHIDDEN" style='display:none;'>
        ...
        <div class="row no-margin">
            <div class="span">
                ...
                <div class="input-control text" data-role="input-control">
                    <textarea name="Description" id="Description" cols="96" rows="5"></textarea>
                </div> <!-- input-control text -->
            </div> <!-- span8 -->
        </div> <!-- row no-margin -->
