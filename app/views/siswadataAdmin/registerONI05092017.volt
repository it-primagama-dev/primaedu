...
<nav class="navigation-bar blue">
    <nav class="navigation-bar-content">
        ...
        <span class="element-divider"></span>
        <span class="element"><strong> <button class="medium danger">Reset Email</button></strong></span>
...
{{ form("SiswadataAdmin/save", "method":"post", "id":"myform") }}
    ...
    <div class="row no-margin">
        ...
        <div class="span3">
            ...
            <div class="input-control text" data-role="input-control">
        <input type="text" id="JenisKelamin" name="JenisKelamin" value="{{ list.JenisKelamin }}"> </input>
            </div>
        </div>
         ...
         <div class="span3">
            ...
            <div class="input-control text" data-role="input-control">
        <input type="text" id="Agama" name="Agama" value="{{ list.Agama }}"> </input>
            </div>
        </div>
	...
	<div class="row no-margin">
		 <div class="span3">
            ...
            <label for="Propinsi">Propinsi</label>
                <div class="input-control text" data-role="input-control">
        <input type="text" id="Propinsi" name="Propinsi" value="{{ list.Propinsi }}"> </input>
                </div></div>
            <div class="span3">
            <label for="Kota">Kota</label>
                <div class="input-control text" data-role="input-control">
        <input type="text" id="Kota" name="Kota" value="{{ list.Kota }}"> </input>
                </div></div>
            <div class="span3">
