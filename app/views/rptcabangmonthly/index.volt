...
{{ form("rptcabangmonthly/search", "method":"post", "target" : "_blank") }}

<div align="left">
    <h1>Laporan Cabang Per-Bulan</h1>
</div> 
        ...
        <div class="span10">
            <div class="span6">
                ...
                <div class="input-control" data-role="input-control">
                    {{ select("Cabang", cabangtx, "using" : ["KodeAreaCabang","NamaCabang"],
"useEmpty": true, "emptyValue": "", "emptyText": "---", "style" : "width:100%") }}
            ...
            <div class="span4">
                ...
                {{ select_static("TA", ["" : "---","1" : "2015/2016", "2" : "2016/2017", "3" : "2017/2018"])}}
                </div>
            </div>
        </div>
        </div>
