...
<table class="table bordered hovered table2excel" style="table-layout: fixed; border-collapse: collapse">
	...
	{% set no=0%}
        <tr>
            ...
            <th width="140px" rowspan="2">Tanggal Submit</th>
            <th width="140px" rowspan="2">Tanggal Approved</th>
			 <th width="140px" rowspan="2">Area</th>
			 <th width="140px" rowspan="2">Kode Cabang</th>
			 <th width="200px" rowspan="3">Nama Cabang</th>
            <th width="200px" rowspan="2">Kode Pembayaram</th>
            <th width="200px" rowspan="3"  colspan="2" >Nominal</th>
            <th width="200px" rowspan="3">Nama Bank</th>
	...
	{% if result is not empty %}
					{% for list in result %}
						...
						<tr>
							...
							<td  bgcolor="#FFEBCD" width="140px" align="center">{{list.PurchReqDate}}</td>
                            <td  bgcolor="#FFEBCD" width="140px" align="center">{{list.ApprovalDate}}</td>
							<td  bgcolor="#FFEBCD" width="140px" align="center" >{{list.area}}</td>
							<td  bgcolor="#FFEBCD" width="140px" align="center" >{{list.KodeAreaCabang}}</td>
							<td  bgcolor="#FFEBCD" width="200px" >{{list.NamaAreaCabang}}</td>
							<td bgcolor="#FFEBCD" width="200px" align="center" >{{list.PurchReqId}}</td>
							<td  bgcolor="#FFEBCD" width="200px" align="center"  colspan="2"><b>Rp {{list.Nominal|number_format(0,',','.')}}</td>
							<td  bgcolor="#FFEBCD" width="200px" align="center">{{list.Bank}}</td>
						</tr>	
					{% endfor %}
				{% endif %}
