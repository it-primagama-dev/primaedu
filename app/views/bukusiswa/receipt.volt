...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="bodyPrint">
        {% for datareport in data %}
            {% if not loop.first and loop.index is odd %}
                ...
                <tr>
                    <td colspan="7">
                        <table style="width:100%;">
                            <tr>
                                <td align="center"><img src="{{ url("img/logo-primagama-kiri-small.png") }}" width="120"></td>
                                <td align="center" width="75%">
                                    <h2><u>TANDA TERIMA BUKU</u></h2>No. {{ datareport["documentno"] }}
                                </td>
                    ...
                    <td colspan="7">
                        <table class="tablePrintContent">
                            <tr>
                                <td>Tanggal</td>
                                <td>:</td>
                                <td>{{ datareport["tanggalterima"] }}</td>
                            </tr>
                            <tr>
                                <td>Nama Siswa</td>
                                <td>:</td>
                            ...
                            <tr>
                                <td>Nama Buku</td>
                                <td>:</td>
                                <td>{{ datareport["namabuku"] }}</td>
                            </tr>
                            <tr>
                                <td>Jumlah Buku</td>
                                <td>:</td>
                                <td>{{ datareport["jumlah"] }}</td>
                            </tr>
                            <tr>
                                <td>Serial Number</td>
                                <td>:</td>
                                <td>{{ datareport["serialnumber"] }}</td>
                            </tr>
                        </table>
