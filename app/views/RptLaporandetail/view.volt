...
{% if username == 'ridwan.sobar' and username == 'jeremia' %}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
               ...
               {#<h1> <a href="{{ url('Rptsiswapiutangcabang/view?cabang='~list.RecID)}}">Tampilkan</a> </h1>#}
            </div>
        </div>
    </div>
</div>
{{ end_form() }}
{% else %}
<a href="{{ url('Rptsiswapiutangcabang/view?cabang='~list.RecID)}}">Rp {{list.Uang_masuk|number_format(0,',','.') }}</a>
{% endif %}
