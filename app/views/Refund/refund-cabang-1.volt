...
{{ form("refund/simpanDeposite1", "onSubmit": "return validasi3();", "method":"post",  "autocomplete" : "off","name":"form3") }}
    <div class="grid fluid">
    <div class="row">
...
<input type="hidden" name="Cabang" value="{{ kodecbg }}">
        ...
        <div class="span11">
            ...
            <div class="input-control select" data-role="input-control">
                {{ select_static("JenisDeposit", ["":"---","00" : "Pembayaran Buku","01" : "Pembayaran Ongkir, RFID", "02" : "Deposit", "03" : "Franchise Fee"]) }}
            </div>
        </div>
        <div class="span11">
        ...
        <div class="span11">
            ...
            <div class="input-control textarea" data-role="input-control">
                <div class='printchatbox'>Sehubungan telah terjadinya kesalahan transfer salah input <span class="ket"></span> dengan <span class="novasalahdeposit"></span>. Nominal yang disetor sebesar <span class="jumlahdisetor"></span> maka, <span class="nominalku"></span> kami mohon <span class="nextaction"></span></div>
            </div>
        </div>
            ...
            <div class="span12 no-margin">
                <div class="panel-body sp">
                    ...
                    <ol>
                        ...
                        <li>Proses kurang lebih 1 (satu) bulan</li>
                    </ol>
                </div>
            </div>
...
function validasi3(){
    ...
    if(form3.JenisKesalahan.value=="" || form3.JenisKesalahan.value==null){
        alert("Pilih Jenis Kesalahan terlebih dahulu"); return false;
    }
    if(form3.TahunAjaran.value=="" || form3.TahunAjaran.value==null){
...
$('#JenisDeposit').change(function(event) {
    ...
    var jumlahdisetor = document.getElementById("jumlahdisetor").value;
    var jumlahdeposit = document.getElementById("jumlahdeposit").value;
    if(newText==='00')
    {
        $('.nextaction').text("dialokasikan untuk Pembayaran Buku.");
    }
    if(newText==='01')
    {
        $('.nextaction').text("dialokasikan untuk Pembayaran Ongkir / RFID.");
    }
    if(newText==='02')
    {
        $('.nextaction').text("dialokasikan untuk Deposit.");
    }
    if(newText==='03')
    {
        $('.nextaction').text("dialokasikan untuk Franchise Fee.");
    }
    if(novasalah1=='')
    {
    ...
    if(novabenar1=='')
    {
        $('.nominalku').text(" nominal sebesar " + jumlahdeposit);
    }
});
...
$('#JenisKesalahan').change(function() {
  if ($(this).val() == '01') {
    ...
    $('#jumlahdeposit').prop('disabled', false);
   $('#jumlahbenar').prop('disabled', false);
  }
  else if ($(this).val() == '02') {
    $('#novabenar1').prop('disabled', false);
    $('#novasalah1').prop('disabled', false);
   {# $('#jumlahdeposit').prop('disabled', true); #}
    $('#jumlahbenar').prop('disabled', true);
  }
  else
  {
