{{ content() }}
{{ form("Konfirmasipembayaran/save", "method":"post") }}

<h1>
    {{ link_to("Konfirmasipembayaran/index", '<i class="icon-arrow-left-3 fg-darker smaller"></i>') }}
   Pembayaran
    <small class="on-right">Ubah Detail Konfirmasi Pembayaran</small>
</h1>
