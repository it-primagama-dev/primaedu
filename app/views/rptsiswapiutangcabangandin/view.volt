        ...
        <td colspan="7">
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td>
                        <h3 class="text-right" style="margin:4px 0">Periode : {{ rpt_tahun }}</h3>#}
                    </td>
                </tr>
            </table>    
        </td>
                        ...
                        {% for list in result %}
                            ...
                            {% if currarea != lastarea and not loop.first %}
                                <tr class="text-right" style="background: #f0f0f0; font-weight: bold">
                                    ...
                                    {% if h100 != 0 %}
                                    <td>{{ (h100*89/100)|number_format(0,',','.') }}</td>
                                    <td>{{ (h100*11/100)|number_format(0,',','.') }}</td>
                                    {% else %}
                                    <td>0</td>
                                    <td>0</td>
                                    {% endif %}
                            ...
                            {% endif %}
                                ...
                                <tr class="text-right" style="background: #f0f0f0; font-weight: bold">
                                    ...
                                    <td>{{ subD689|number_format(0,',','.')  }}</td>
                                    <td>{{ subD611|number_format(0,',','.')  }}</td>
                                    <td>{{ subd6100|number_format(0,',','.')  }}</td>
                                    {% if subd6100 != 0 %}
                                    <td>{{ (subd6100*89/100)|number_format(0,',','.')  }}</td>
                                    <td>{{ (subd6100*11/100)|number_format(0,',','.')  }}</td>
                                    {% else %}
                                    <td>0</td>
                                    <td>0</td>
                                    {% endif %}
