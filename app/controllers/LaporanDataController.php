...
class LaporanDataController extends ControllerBase
{
    ...
    public function indexAction() {
        ...
        $konfirmasipembayaran = $this->modelsManager->createBuilder()
                ...
                ->orderBy(["Purchreqheader.ApprovalDate"])
                ->getQuery()
    ...
    public function viewAction()
    {
        ...
        $sql = "SELECT rtrim(ltrim(SUBSTRING(ItemID,5,4)))as jenjang,RIGHT(ItemName,5)as tahun,NamaAlias as ItemID,Qty from purchreqline join purchreqheader on(purchreqline.Purchreqheader=purchreqheader.RecId)
