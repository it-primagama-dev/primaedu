...
set_time_limit(600);
class Rptsiswacabang1Controller extends ControllerBase
{
    ...
    public function initialize() {
        ...
        $this->view->rpt_title = 'Laporan Jenjang';
    }
 ...
 public function viewAction() {
        ...
        if (!$this->request->isPost()) {
            return $this->forward('rptsiswacabang1/index');
        }
        ...
        $sql = "select VirtualAccount,MD, NamaSiswa,NamaProgram ,NamaJenjang,Cabang,sum(JumlahTotal)as JumlahTotal, 
(select sum(transaksibank.Nominal) as Uang_masuk from transaksibank where transaksibank.Siswa = cte.RecID and tahunajaran=$tahun)as Uang_masuk,
+(select sum(jumlah) as uang from pembayarandetail join pembayaran on pembayaran.RecID=pembayarandetail.Pembayaran
                ...
                from
(select siswa.VirtualAccount,Siswa.RecId,Siswa.MD,program.NamaProgram,jenjang.NamaJenjang,areacabang.kodeareacabang, siswa.NamaSiswa,siswa.cabang, 
               ...
               and pembayarandetail.pembayaranuntuk='Pendaftaran'
                ...
                tahunajaran.Description,pembayarandetail.Jumlah,jenjang.NamaJenjang,areacabang.kodeareacabang) as cte
                group by VirtualAccount,MD,NamaSiswa,Cabang,RecID,NamaJenjang,NamaProgram,kodeareacabang";
