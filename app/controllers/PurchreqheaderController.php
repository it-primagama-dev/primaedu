...
class PurchreqheaderController extends ControllerBase {
    ...
    public function newAction() {
        ...
        $sql = "select ISNULL(Cilegal,0) as cilegal from Areacabang where RecID ='{$cabang}'";
        ...
        if ($chek == 1) {
            ...
            window.alert('silahkan Hubungi Pak Julian 08118828368 Pak Ayub : 08118828392 Pak Nasution 08119926912  Pak budi Maryatno 08122953799');
            </script>
            ...
            ->join('Areacabang','Purchreqheader.Cabang = Areacabang.RecID ')
            ->where("Cabang = '$cabang' and Status = 'Approved' and ApprovalDate >= '2017-06-01' and Cilegal != '1'")
            ->execute();
