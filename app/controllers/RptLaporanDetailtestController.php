...
class RptLaporanDetailtestController extends ReportBase
{
  ...
  -- join areacabang on transaksibank.KodeCabang= areacabang.KodeAreaCabang
   where transaksibank.KodeCabang = areacabang.KodeAreaCabang and transaksibank.tahunajaran = program.tahunajaran) as Uang_masuk,
