...
class RptrekapsiswaController extends ControllerBase
{
...
SQL;
    ...
    public function initialize() {
        $this->tag->setTitle('Laporan Jumlah Siswa');
        parent::initialize();
    ...
    public function viewAction()
    {
        if (!$this->request->isPost()) {
            return $this->forward('rptrekapsiswa/index');
        }
        ...
        $this->view->rpt_title = 'Laporan Jumlah Siswa';
