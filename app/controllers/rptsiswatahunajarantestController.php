...
class RptsiswatahunajarantestController extends ControllerBase
{
 ...
 public function viewAction() {
        ...
        $sql = "select  siswa.NamaSiswa as siswa, areacabang.RecID, transaksibank.NamaBank,transaksibank.TanggalTransaksi,transaksibank.TanggalImport,transaksibank.WaktuTransaksi,transaksibank.NoVA,transaksibank.Nominal, tahunajaran.Description  from transaksibank 
        left join areacabang on SUBSTRING(transaksibank.NoVA,0,5)=areacabang.KodeAreaCabang
        join siswa on SUBSTRING(transaksibank.NoVA,5,7) = siswa.VirtualAccount and siswa.Cabang = areacabang.RecID
