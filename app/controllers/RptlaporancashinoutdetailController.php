<?php
set_time_limit(300);
class Rptlaporancashinoutdetailcontroller extends ControllerBase
{
 ...
 public function viewAction($id) {
       ...
       // echo"$idbln<br>";
        ...
        $sql2="Select DATENAME(month, Tanggal) as bulan, MONTH(Tanggal) as bln,CashInOut.Nominal as Jumlah
                , Year(Tanggal) as tahun, CashInOut.IDTipe as TypeId,CashInOutType.Deskripsi as dec,CashInOut.IDHuruf
                ,CashInOut.Tanggal,CashInOut.CreatedAt,CashInOut.Description,CashInOut.IDGroup
                ...
                where cabang='$cabang' and MONTH(Tanggal)='$idbln' and Year(Tanggal)='$idthn'
                GROUP BY DATENAME(month, Tanggal),MONTH(Tanggal),YEAR(Tanggal),
                CashInOut.IDTipe, CashInOutType.Deskripsi,CashInOut.IDHuruf,Tanggal,CreatedAt,Nominal,Description,IDGroup
                ORDER BY IDTipe asc";
        ...
        $sql3="select DATENAME(MONTH,TanggalTransaksi) as bulan, MONTH(TanggalTransaksi) as bln,
                ...
                and MONTH(TanggalTransaksi)='$idbln' and Year(TanggalTransaksi)='$idthn'
        ...
        $sql5="Select DATENAME(month, Tanggal) as bulan, MONTH(Tanggal) as bln,CashInOut.Nominal as Jumlah
                , Year(Tanggal) as tahun, CashInOut.IDTipe as TypeId,CashInOutType.Deskripsi as dec,CashInOut.IDHuruf
                ,CashInOut.Tanggal,CashInOut.CreatedAt,CashInOut.Description,CashInOut.IDGroup,CashInOutType.ClassId
                from CashInOut join areacabang on CashInOut.Cabang=areacabang.KodeAreaCabang
                join CashInOutType on CashInOutType.RecID=CashInOut.IDTipe
                join CashInOutTypeClass on CashInOutTypeClass.RecId=CashInOutType.ClassId
                where cabang='$cabang' and MONTH(Tanggal)='$idbln' and Year(Tanggal)='$idthn'
                GROUP BY DATENAME(month, Tanggal),MONTH(Tanggal),YEAR(Tanggal),
                CashInOut.IDTipe, CashInOutType.Deskripsi,CashInOut.IDHuruf,Tanggal,CreatedAt,Nominal,Description,IDGroup,CashInOutType.ClassId
                ORDER BY bln asc";
