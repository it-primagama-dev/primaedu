...
class RptbukubnyakController extends ControllerBase
{
...
order by [Jumlahqty] desc
SQL;


    public function initialize() {
        $this->tag->setTitle('Laporan Jumlah Buku Terbanyak');
        parent::initialize();
    ...
    public function viewAction()
    {
        if (!$this->request->isPost()) {
            return $this->forward('rptbukubnyak/index');
        }
...
//        $dateto = $this->request->getPost('DateTo', 'int') ? : date('Y-m-d');
        ...
        $this->view->rpt_title = 'Laporan Jumlah Buku Terbanyak';
