    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <div class="col-lg-12">
                <p style="font-size: 23px; font-weight: bold;"><i class="fa fa-paypal"> Pembayaran Program Siswa</i></p>
                <legend></legend>
                </div>
            </div>
        </div>
...
function printandpay() {
  ...
  //alert(StudentID);
  redirectPost(base_url+"student/detail_st", {StudentID:window.btoa(StudentID),Code:window.btoa(1)});
}
