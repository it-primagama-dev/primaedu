...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="bodyPrint">
        <span onclick="cetak();" id="printLink" class="btn btn-success" style="float:right">Print</span>
        <br/>
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td style="text-align:center;vertical-align:middle;">
                                    <img src="<?php echo base_url(); ?>assets/images/logo_new_web.png" width="140">
                                </td>
                                <td align="center" width="75%">
                                    <h2 style="margin:5px"><u>KUITANSI PEMBAYARAN</u></h2>No.
                                </td>
                        ...
                        <table class="tablePrintBottom">
                            <tr>
                                <td class="posLeft">
                                    <table style="width:100%; margin-bottom: 70px">
                                        <tr>
                                            <td class="totalAmount">Terbilang : </td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="width:20%">
                                    <table style="width:100%; margin-bottom: 70px">
                                        <tr>
                                            <td colspan="2" align="center">Jakarta, 27 Maret 2020</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td class="posLeft">
                                    <table style="width:100%">
                                        <tr>
                                            <td align="left" style="font-weight:bold; font-size: 10px"><em><i>Dokumen ini merupakan bukti pembayaran resmi yg dicetak oleh sistem<br/>(Cetakan Ke-<span class="print-counter">1</span>)</i></em></td>
                                        </tr>
