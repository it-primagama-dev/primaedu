    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <div class="col-lg-12">
                <p style="font-size: 23px; font-weight: bold;"><i class="fa fa-list"> Approval Perubahan Data</i></p>
                <legend></legend>
                </div>
            </div>
        </div>
                ...
                <table class="table table-bordered table-hover" cellspacing="0" id="tableMenu" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">Request Dari</th>
...
<div class="row" id="editdiv" style="display: none;">
    <div class="col-lg-12">
        ...
        <div class="form-group">
            <div class="col-lg-2" id="btnsave">
            <button type="button" class="btn btn-success" onclick="save()"><span class="glyphicon glyphicon-ok"></span> Approve</button>
            </div>
            <div class="col-lg-2" id="btnreject">
            <button type="button" class="btn btn-danger" onclick="reject()"><span class="glyphicon glyphicon-remove"></span> Reject</button>
            </div>
            <div class="col-lg-2">
        ...
        $.ajax({
            ...
            success: function(data)
            {
                if(data.StatusApproval == 0){
                    $('#btnreject').css('display','show');
                    $('#btnsave').css('display','show');
                } else {
...
function save() 
{
    if (confirm("Anda yakin akan Approve ?")) {
    url = base_url + "Franchise/saveedit";
    ...
    formdata['RecID'] = window.btoa($('#RecID').val());
        $.ajax({
            url : url,
            type: "POST",
            data: formdata,
...
function reject() 
{
    if (confirm("Anda yakin akan Reject ?")) {
    url = base_url + "Franchise/savereject";
    var formdata = {};
    formdata['token'] = unescape(encodeURIComponent("Q3IzNHQzZF9ieS5IQG1aNGg="));
    formdata['RecID'] = window.btoa($('#RecID').val());
        $.ajax({
