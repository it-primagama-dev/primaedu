    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <div class="col-lg-12">
                <p style="font-size: 23px; font-weight: bold;"><i class="fa fa-list"> Laporan Detail Franchise Fee Per-Tahun Akhir</i></p>
                <legend></legend>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <div class="col-lg-2">
                    ...
                    <input type="text" id="DateFrom" name="DateFrom" class="form-control" value="">
                </div>
            </div>
            <div class="form-group">
                <div class="col-lg-5">
                ...
                <a class="btn btn-info btn-xs" href="javascript:void(0)" type="button" data-toggle="modal" onclick="print()"> Cetak</a> -->
                </div>
            </div>
            <legend></legend>
        </div>
        ...
        minViewMode: "years"
                        ...
                        function load_data() {
                            ...
                            if($('[name="DateFrom"]').val() == "") {
                                $('[name="DateFrom"]').after('<p class="text-danger"><i class="fa fa-info-circle"></i> Pilih Tahun Akhir !</p>');
                                $('[name="DateFrom"]').focus();
                                return false;
                            } else {
                                $('#idtable').css('display', 'block');
                                jQueryTable = $("#tableMenu").DataTable({
                                    ...
                                    "scrollCollapse": true,
                                    "ajax": {
                                        "url":base_url + "Franchise/loadlistdatefrom",
                                        "type":"POST",
...
//                                jQueryTable.columns.adjust().fixedColumns().relayout().draw();
                                ...
                                $.ajax({
                                    url : base_url+"Franchise/loadlistdatefrom",
                                    type: 'POST',
                                    data: ({DateFrom:window.btoa(DateFrom),token:window.btoa("Q3IzNHQzZF9ieS5IQG1aNGg=")}),
                                    dataType: 'json',
